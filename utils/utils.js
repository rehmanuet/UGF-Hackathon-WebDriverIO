...
var dataProvider = [
    ...
    { width: 1200, height: 700, device: "Laptop", dom: "#A____203", name: "List Icon", expect: true },
    ...
    { width: 500, height: 700, device: "Mobile", dom: "#UL____269", name: "Product Icons", expect: true },
